...
function MPOptim_SettingsUI:createChildren()
    ...
    addTick(self.panelTab2, startOptY + (6 * self.tickSpacing), MPOptim.GetText("UI_ModOptions_Threaded_Lighting", "[EXPERIMENTAL] Multi-Threaded Dynamic Lighting"), "Threaded_Lighting", function(sel)
        if MPOptim.HordeOptimizer and MPOptim.HordeOptimizer.Apply then MPOptim.HordeOptimizer.Apply() end
    ...
    addTick(self.panelTab3, startOptY + (6 * self.tickSpacing), MPOptim.GetText("UI_ModOptions_GFX_DynamicReflections", "Dynamic Road & Puddle Reflections"), "GFX_DynamicReflections", function(sel)
    ...
    local stepY3 = startOptY + (7 * self.tickSpacing) + math.floor(14 * scale)
