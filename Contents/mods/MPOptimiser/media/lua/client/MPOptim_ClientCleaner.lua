...
function MPOptim.ClientCleaner.CleanAroundPlayer(radius, options, onComplete)
    ...
    local cleanOpts = options or {
        ...
        cleanTracks = MPOptim.Config and MPOptim.Config.Get("Animal_CleanTracks"),
...
function MPOptim.ClientCleaner.QuickClean(cleanType, radius)
    ...
    local opts = {
        ...
        cleanTracks = (cleanType == "all" or cleanType == "debris" or (MPOptim.Config and MPOptim.Config.Get("Animal_CleanTracks"))),
